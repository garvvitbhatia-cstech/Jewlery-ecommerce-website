            ...
            <div class="card border-0">
              ...
              <div class = "product-imgs">
                <div class = "img-display" id="main_img_div">
                  <div class = "zoom">
                    @if($product->image == '')
                      <img src = "{{ asset('public/img/home/no-image.png')}}" alt = "{{$product->title}}">
                    @else
             
                      <img src = "{{ asset('public/admin/images/teams/')}}/{{$product->image}}" id="main_img" alt = "{{$product->title}}">
                ...
                <div class="img-item">
                    <a onclick="updateZoom('{{ asset('public/admin/images/teams/')}}/{{$product->image}}');" data-id = "1">
                      <img src="{{ asset('public/admin/images/teams/')}}/{{$product->image}}" alt="{{$product->title}}">
                    </a>
                  </div>
                  @foreach($product_images as $key => $image)
                  <div class="img-item">
                    <a onclick="updateZoom('{{ asset('public/admin/images/products/')}}/{{$image->image}}');" data-id = "{{$key+2}}">
                      <img src="{{ asset('public/admin/images/products/')}}/{{$image->image}}" alt="{{$product->title}}">
                    </a>
                  </div>
                  @endforeach
                </div>
              ...
              <div class ="product-content">
                ...
                <div class = "product-rating">
                  <img src="{{ asset('public/img/home/')}}/Star.svg" width="100" alt="">
                  <span>1 Review</span>
                </div> 
                <h4 class="price">₹ {{number_format($product->amount,2)}}</h4> 
                  {!! $product->content !!}
                  ...
                  <div class="row align-items-center">
                    ...
                    <div class="col-md-12 my-4">
                      ...
                      <a href="javascript:void(0)" id="add_to_cart_{{$product->id}}" onclick="addTocart('{{$product->id}}')" class="btn theme-btn border">Add To Cart</a>
                      @else
                        <a href="javascript:void(0)" id="add_to_cart_{{$product->id}}" onclick="addTocart('{{$product->id}}')" class="btn theme-btn border">Add To Cart</a>
                      @endif
                    </div>
                  ...
                  <div class="col-md-12">
                    <ul class="d-flex flex-wrap align-items-center">
                      <li><a href=""><img src="{{ asset('public/img/home/')}}/1.svg" alt=""></a></li>
                      <li><a href=""><img src="{{ asset('public/img/home/')}}/2.svg" alt=""></a></li>
                      <li><a href=""><img src="{{ asset('public/img/home/')}}/3.svg" alt=""></a></li>
                      <li><a href=""><img src="{{ asset('public/img/home/')}}/4.svg" alt=""></a></li>
                      <li><a href=""><img src="{{ asset('public/img/home/')}}/5.svg" alt=""></a></li>
                      <li><a href=""><img src="{{ asset('public/img/home/')}}/6.svg" alt=""></a></li>
                    </ul>
                  </div>
                </div>
      ...
      <div class="col text-start">
        <div class="pr-img">
          <div class="product-box-pt">
            @if($product->image != '')
              <img src = "{{ asset('public/admin/images/teams/')}}/{{$product->image}}" alt = "shoe image">
            @endif
            <div class="pro-cont">
          ...
          <p><span>₹ {{$product->amount}}</span></p></a>
        </div>
      </div>
      @endforeach
...
function updateZoom(img_path){
	$.ajax({		
      ...
      url: "{{route('products.get_products_image')}}",
	  type:'POST',
