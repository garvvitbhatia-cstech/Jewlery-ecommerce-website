                  ...
                  <div class="col-md-5">
                    ...
                    <div class="col-md-2">
                      <div class="form-group">
                        ...
                        <img src="{{URL::asset('public/admin/images/testimonials/')}}/{!! $rowData->image !!}" style="max-width: 80px;height: auto;"> 
                      </div>
                    </div>
                    @endif 
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <textarea class="form-control editorBox" name="description" rows="6" placeholder="Description" id="description">{!! $rowData->description !!}</textarea>
                      </div>
                    </div>         
                  </div>                
                </div>
...
<script>
    ...
    let saveDataURL = "{{url('/admin/edit-brand/'.$row_id)}}";
    let returnURL = "{{url('/admin/brands')}}";
</script>
<script src="{{ asset('public/admin/js/pages/brands/add-page.js') }}"></script>
