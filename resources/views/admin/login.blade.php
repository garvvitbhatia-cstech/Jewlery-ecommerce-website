...
<div id="auth">
    ...
    <div class="row h-100">
        ...
        <div class="col-lg-7 d-none d-lg-block">
            ...
            <div id="auth-right"><img src="{{ asset('public/admin/images/IMG_6099.JPG') }}" style="height:auto; width:100%" alt="Logo"></div>
        ...
        <div class="col-lg-5 col-12">
            ...
            <div id="auth-left">
                ...
                <div class="auth-logo">
                    ...
                    <a href="{{url('/admin')}}"><img src="{{ asset('public/admin/images/logo.jpeg') }}" style="height:auto; width:100%" alt="Logo"></a>
