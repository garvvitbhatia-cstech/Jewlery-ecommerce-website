                  ...
                  <div class="row">
                    ...
                    <div class="col-md-3">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Enter State" value="{{$rowData->state}}" name="state" id="state">
                        ...
                        <select name="country" id="country" class="form-select">
                          ...
                          <option value="">Select Country</option>
                                ...
                                @foreach($country_list as $key => $country)
                                    <option {{$country->id == $rowData->country?'selected':''}} value="{{$country->id}}">{{$country->country_name}}</option>
                                @endforeach
