                     ...
                     <div class="row">
                        <div class="col-md-12">
                           <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="question" id="question" value="{{$rowData->question}}" placeholder="Question">
                           </div>
                        </div>
                        <div class="col-md-12">
                           <div class="form-group">
                              <label for="basicInput">Answer</label>
                              <textarea class="form-control editorBox" name="answer" id="answer">{{$rowData->answer}}</textarea>
                           </div>
                        </div>
                        <div class="row">
                           <div class="col-md-4">
                              ...
                              <input class="form-check-input" type="checkbox" value="1" id="status" name="status" {{$rowData->status == 1?'checked':''}}>
