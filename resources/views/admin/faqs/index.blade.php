   ...
   <section class="section">
      <div class="card">
         ...
         <div class="card-body">
            ...
            <a href="{{url('/admin/add-faq')}}" class="btn icon btn-sm btn-outline-success float-end">Add New Faq</a>
         </div>
         <!--end::Card body-->
      </div>
   </section>
                  ...
                  <div class="table-responsive">
                     <table class="table mb-0">
                        ...
                        <tbody id="replaceHtml">
                           <tr>
                              <td colspan="15" class="text-center"><img src="{{ asset('public/admin/images/svg/oval.svg') }}" class="me-4" style="width: 3rem" alt="audio"></td>
                           </tr>
                        </tbody>
                     </table>
                  </div>
