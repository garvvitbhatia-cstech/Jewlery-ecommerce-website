                  ...
                  <div class="col-md-5">
                    ...
                    <div class="col-md-2">
                      <div class="form-group">
                        ...
                        <img src="{{URL::asset('public/admin/images/testimonials/')}}/{!! $rowData->profile !!}" style="max-width: 80px;height: auto;"> 
                      </div>
                    </div>
                    @endif 
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <textarea class="form-control" name="testimonial" rows="6" placeholder="Testimonial" id="testimonial">{!! $rowData->testimonial !!}</textarea>
                      </div>
                    </div>
                  </div>                
                </div>
