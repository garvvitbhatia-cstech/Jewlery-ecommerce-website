                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                      ...
                      <div class="form-group">
                        ...
                        <select name="parent_id" id="parent_id" confirmation="false" class="form-select">
							              ...
							              {{ Helper::getSubCategory($categoryList,$rowData->parent_id,$rowData->id) }}
                    ...
                    <div class="col-md-2">
                      ...
                      <div class="form-group">
                        ...
                        <img src="{{URL::asset('public/admin/images/teams/')}}/{!! $rowData->image !!}"  style="max-width: 80px;height: auto;"> </div>
                    ...
                    <div class="col-md-2">
                      ...
                      <div class="form-group">
                        ...
                        <img src="{{URL::asset('public/admin/images/teams/')}}/{!! $rowData->icon !!}"  style="max-width: 80px;height: auto;"> </div>
                    ...
                    <div class="col-md-4">
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-check">
                          ...
                          <input type="checkbox" class="form-check-input" id="is_featured" name="is_featured" {{$rowData->is_featured == '1'?'checked':''}} value="1">
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control" name="description" rows="6" placeholder="Description" id="description">{{$rowData->description}}</textarea>
