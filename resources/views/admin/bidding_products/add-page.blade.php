         ...
         <div class="col-12 col-md-6 order-md-2 order-first">
            ...
            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
               ...
               <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="{{url('/admin/bidding_products')}}">Bidding Products</a></li>
                              ...
                              <div class="col-md-4">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <select class="form-select" name="category_id" id="category_id">
                                       ...
                                       {{ Helper::getSubCategory($category_list) }}
...
<script>
   ...
   $('.numberonly').keypress(function(e){
      ...
      let saveDataURL = "{{url('/admin/add-bidding-product')}}";

      let returnURL = "{{url('/admin/bidding-products')}}";
