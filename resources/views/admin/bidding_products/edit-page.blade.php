         ...
         <div class="col-12 col-md-6 order-md-2 order-first">
            ...
            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
               ...
               <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="{{url('/admin/bidding-products')}}">Bidding Products</a></li>
                           ...
                           <div class="row">
                              ...
                              <div class="col-md-4">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="text" name="start_price" id="start_price" maxlength="8" value="{{$rowData->start_price}}" class="form-control numberonly" />
                              ...
                              <div class="col-md-4">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="datetime-local" name="start_date" id="start_date" value="{{$rowData->start_date}}"  class="form-control"/>
                              ...
                              <div class="col-md-4">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="datetime-local" name="end_date" id="end_date"  value="{{$rowData->end_date}}"  class="form-control"/>
                              ...
                              <div class="col-md-4">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="text" name="quantity" id="quantity"  value="{{$rowData->quantity}}" class="form-control numberonly"/>
                              ...
                              <div class="col-md-12">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{$rowData->title}}" name="title" id="title"/>
                              ...
                              <div class="col-md-12">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <textarea class="form-control editorBox" value="" name="content" id="content">{{$rowData->content}}</textarea>
                              ...
                              <div class="col-md-12">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{$rowData->heading}}" name="heading" id="heading">
                           ...
                           <div class="row">
                              ...
                              <div class="col-md-12">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="3" name="seo_title" id="seo_title">{{$rowData->seo_title}}</textarea>
                              ...
                              <div class="col-md-6">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="6" name="seo_description" id="seo_description">{{$rowData->seo_description}}</textarea>
                              ...
                              <div class="col-md-6">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="6" name="seo_keyword" id="seo_keyword">{{$rowData->seo_keyword}}</textarea>
...
<script>
   ...
   $('.numberonly').keypress(function(e){
      ...
      let saveDataURL = "{{url('/admin/edit-bidding-product/'.$row_id)}}";     

      let returnURL = "{{url('/admin/edit-bidding-product/'.$row_id)}}";     

</script> 

<script src="{{ asset('public/admin/js/pages/bidding_products/add-page.js') }}"></script> 
