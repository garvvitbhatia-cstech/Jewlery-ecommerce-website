   ...
   <section class="section">
      ...
      <div class="card">
         ...
         <div class="card-body">
            ...
            <form id="searchForm" name="searchForm" class="float-start">
               ...
               <div class="d-flex align-items-center  w-md-800px">
                  ...
                  <option value="">Select Category</option>
                     @if(isset($category_list) && $category_list->count()>0)                        
            ...
            <a href="{{url('/admin/add-bidding-product')}}" class="btn icon btn-sm btn-outline-success float-end">Add New Bidding Product</a>
...
<script type="text/javascript">
   ...
   function filterData(type = null){   
   		...
   		$.ajax({   
			...
			url: "{{ url('/admin/bidding_products_paginate') }}",	   
