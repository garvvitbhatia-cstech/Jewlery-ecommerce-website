            ...
            <div class="col-md-8">
                ...
                <form action="" method="post" id="checkout-form" class="shipping-adderss-main my-4">
                    ...
                    <div class="row g-3 my-2">
                        @php
                        $explodeName = explode(" ",$userData->name);
                        @endphp
                        <div class="col-md-6">
                            <label for="o_first_name" class="form-label">First Name</label>
                            <input type="text" class="form-control" value="{{isset($explodeName[0]) ? $explodeName[0] : ''}}" id="o_first_name" name="o_first_name" placeholder="Enter your first name">
                        </div>
                        <div class="col-md-6">
                            <label for="o_last_name" class="form-label">Last Name</label>
                            <input type="text" class="form-control" id="o_last_name" name="o_last_name" value="{{isset($explodeName[1]) ? $explodeName[1] : ''}}" placeholder="Enter your last name" >
                        </div>
                        
                        <div class="col-md-12">
                            <label for="o_address" class="form-label">Address</label>
                            <input type="text" class="form-control" id="o_address" value="{{$userData->address}}" name="o_address" placeholder="Enter your address" >
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="o_country" id="o_country" class="form-select">
                                ...
                                @foreach($country_list as $key => $country)
                                    <option @if($userData->country == $country->id) selected @endif value="{{$country->country_name}}">{{$country->country_name}}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-md-4">
                            <label for="o_pincode" class="form-label">Pincode</label>
                            <input type="text" class="form-control numberonly" id="o_pincode" name="o_pincode" value="{{$userData->zipcode}}" maxlength="6" placeholder="6 digits pincode" >
                        </div>
                        <div class="col-md-4">
                            <label for="o_mobile" class="form-label">Phone No</label>
                            <input type="text" class="form-control numberonly" maxlength="10" name="o_mobile" value="{{$userData->mobile}}" id="o_mobile" placeholder="Enter your phone no">
                        </div>
                    ...
                    <div class="row mt-4">
                        <div class="col-md-6 col-lg-4">
                            <div class="form-check align-items-center mb-3">
                                <input class="form-check-input mt-0" onchange="$('#payment_method').val('Online');" type="radio" checked="checked" name="flexRadioDefault" value="Online" id="flexRadioDefault1">
                                <label class="form-check-label ps-1" for="flexRadioDefault1">Online</label>
                            </div>
                ...
                <div class="d-flex align-items-center justify-content-between pb-4">
                    <a href="{{route('pages.index')}}" class="btn btn-outline-secondary">Continue Shopping</a>
                </div>
            </div>
            <div class="col-md-4">
                    ...
                    <div class="accordion myOrder-tab-cls" id="accordionExample">
                            ...
                            <div class="accordion-header">
                                <div class="accordion-button show" data-bs-toggle="collapse" data-bs-target="#collapsethree" aria-expanded="true" aria-controls="collapsethree">
                                    <span class="fit-box d-flex justify-content-between align-items-center ">
                                        <span class="fitlest-textt d-flex fw-bold align-items-center"> <span class="cart-icons pe-1"><img src="{{$siteUrl}}public/images/cart-icon.svg" alt=""></span>Order Summary</span>
                            ...
                            <div id="collapsethree" class="accordion-collapse show collapse" aria-labelledby="headingtwo" data-bs-parent="#accordionExample">
                                ...
                                <div class="product-list my-3 d-flex">
                                    <a href="#" class="product-img">
                                        <img src="{{URL::asset('public/admin/images/teams')}}/{!! $item->image !!}" width="100%" class="img-bxx">
                                    </a>
                                    <div class="kk-contant-boxb cart-box-cnt w-100 d-flex justify-content-between">
                                        <span>
                                            <a href="#" class="d-block cat-head fs-1 text-capitalize">{{$product_details->title}}</a>
                                            <span class="d-flex kk-price-num align-items-center py-1"> per item</span>
                                        </span>
                                        <div class="price"><small class="fs-6">₹{{$product_details->amount}}</small></div>
                                    </div>
                                </div>
                                @endforeach                             
                        ...
                        <div class="summary-box">
                            <div class="accordion-header">
                                <div class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#collapsefour" aria-expanded="true" aria-controls="collapsethree">
                                    <span class="fit-box d-flex justify-content-between align-items-center ">
                                        <span class="fitlest-textt d-flex fw-bold align-items-center"> <span class="cart-icons pe-1"><img src="{{$siteUrl}}public/images/offers-icon.svg" alt=""></span>Apply Coupon</span>                                        
                                    </span>
                                </div>
                            </div>
                                    ...
                                    <div class="product-list align-items-center d-flex">
                                        <form action="" class=" w-100">
                                            <div class="input-group mt-2 coupon-btn mb-3 d-flex justify-content-between">
                                                <input type="text" id="coupon_code" class="form-control me-3" maxlength="8" placeholder="Enter Coupon Code" @if(Session::has('couponcode.coupontitle')) value="{{ (Session::get('couponcode.coupontitle')) }}" @endif aria-label="Recipient's username" aria-describedby="basic-addon2">
                                                                                                
                                                <div id="delete_coupon_code_div">                                    
                                                   @if(Session::has('couponcode.price'))
                                                        <a href="{{url('/delete-coupon-code')}}" id="delete_coupon_code" class="input-group-text btn btn-danger">DELETE</a>
                                                    @else
                        ...
                        <div class="cart-total-box">
                            <div class="total-price">
                                <p>Total Items:</p>
                                <p class="fw-bold">{{$items->count()}}</p>
                            </div>
                            @if(Session::has('couponcode.price'))
                            <div class="total-price">
                                <p>Discount:</p>
                                <p class="fw-bold">-₹{{(Session::get('couponcode.discount'))}}</p>
                            </div>
                            @else
                            ...
                            <div class="total-price">
                                <p>Total:</p>                                
                                @if(Session::has('couponcode.price'))
                                    <p class="fw-bold grand-total-inner-left-md">₹{{(Session::get('couponcode.price'))}}</p>
                                @else
                                    <p class="fw-bold grand-total-inner-left-md">₹{{$sum}}</p>
                                @endif 
                            </div>
                        </div>
                        <div class="buy-btn-list text-center d-block mt-4">
                            ...
                            <a href="http://" class="d-flex  payments-powered my-4 justify-content-center align-items-center"><span class="ps-2"><img src="{{$siteUrl}}public/img/home/secure-icon.svg" alt=""></span> 100% Secure Payments powered by</a>
                            <a href="http://" class="d-flex justify-content-center">
                                <span><img src="{{$siteUrl}}public/img/home/norton.svg" alt=""></span>
                                <span class="px-2"><img src="{{$siteUrl}}public/img/home/razorpay.svg" alt=""></span>
                                <span><img src="{{$siteUrl}}public/images/paytm.svg" alt=""></span>  
                            </a>
                        </div>                
                    </div> 
                </div>                
...
$('#apply_coupon_code').on('click', function(){
    ...
    if(flag == 0){			
        ...
        var ajaxpath = "{{url('/delete-coupon-code')}}";
        let couponCodeURL = "{{url('/apply-coupon-code')}}";
        $.ajax({
            type: 'POST',
            dataType: 'JSON',
            url: couponCodeURL,
