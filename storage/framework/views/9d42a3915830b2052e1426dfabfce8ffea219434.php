<?php if($records->count()>0): ?>
    ...
    <tr>
        ...
        <td>
            <a href="<?php echo e(url('/admin/edit-vendor',base64_encode($row->id))); ?>" class="btn btn-sm btn-primary" title="Edit">
                <i class="bi bi-pencil"></i>
            </a>
            <a href="javascript:void(0);" onclick="deleteData('users','<?php echo e($row->id); ?>');" class="btn btn-sm btn-danger"  title="Delete">
                <i class="bi bi-trash"></i>
            </a>
            <a href="<?php echo e(url('/admin/login-vendor',base64_encode($row->id))); ?>" class="btn btn-sm btn-danger"  title="Login">
...
<?php /**PATH G:\xampp-8\htdocs\aayush-bharat-admin\resources\views//admin/vendors/paginate.blade.php ENDPATH**/ ?>