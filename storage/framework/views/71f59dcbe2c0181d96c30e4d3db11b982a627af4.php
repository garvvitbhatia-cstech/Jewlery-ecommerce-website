                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                      	<input type="hidden" name="old_profile_image" value="<?php echo e($rowData->image); ?>"/>
					...
					<?php
                    	if($rowData->image != ''){
                    ?>
                        <img src="<?php echo e(URL::asset('public/admin/images/orders/')); ?>/<?php echo $rowData->image; ?>" class="img-rounded" width="100px" height="100px" title="" alt="">
                    <?php
                        }
                    ?>
                    </div>
...
<!-- end plugin js --> 
<script>
    let saveDataURL = "<?php echo e(url('/admin/edit-prescription-order',base64_encode($rowData->id))); ?>";
...
<?php echo $__env->make('layout.admin.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xampp-8\htdocs\aayush-bharat-admin\resources\views//admin/prescription_orders/edit-order.blade.php ENDPATH**/ ?>