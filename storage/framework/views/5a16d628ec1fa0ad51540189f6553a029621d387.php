                     ...
                     <div class="row">
                        <div class="col-md-4">
                           <div class="form-group">
                              ...
                              <input type="text" class="form-control" value="<?php echo e($rowData->title); ?>" maxlength="8" style="text-transform:uppercase" name="title" id="title">
                           </div>
                        </div>
                        <div class="col-md-4">
                           <div class="form-group">
                        ...
                        <div class="col-md-4">
                           <div class="form-group">
                              ...
                              <input type="text" value="<?php echo e($rowData->amount); ?>" class="form-control numberonly" maxlength="4" name="amount" id="amount">
                           </div>
                        </div>
                        <div class="col-md-4">
                           <div class="form-group">
...
<?php echo $__env->make('layout.admin.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xampp-8.2\htdocs\laraval_ecommerce_admin\resources\views//admin/coupon_codes/edit-page.blade.php ENDPATH**/ ?>