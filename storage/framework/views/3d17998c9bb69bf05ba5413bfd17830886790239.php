...
<!-- end plugin js --> 
<script>
    let saveDataURL = "<?php echo e(url('/admin/add-banner')); ?>";
    let returnURL = "<?php echo e(url('/admin/banners')); ?>";
</script> 
<script src="<?php echo e(asset('public/admin/js/pages/banners/add-page.js')); ?>"></script> 

<?php $__env->stopSection(); ?> 
<?php echo $__env->make('layout.admin.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vqtxcve1uvhl/sgj.365wah.com/resources/views//admin/banners/add-page.blade.php ENDPATH**/ ?>