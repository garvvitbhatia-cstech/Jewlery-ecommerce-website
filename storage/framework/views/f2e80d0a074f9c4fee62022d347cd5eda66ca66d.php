        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    ...
                    <p class="text-subtitle text-muted">Ingredients list.</p>
                </div>
            ...
            <div class="card">
               <!--begin::Card body-->
                <div class="card-body">
                    ...
                    <a href="<?php echo e(url('/admin/add-ingredient')); ?>" class="btn icon btn-sm btn-outline-success float-end">Add New Ingredient</a>
    ...
    <div class="modal fade" id="uploadCsvModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <a href="<?php echo e(url('/storage/sample-csv/Ingredients.csv')); ?>" target="_blank" class="btn btn-success">Download Sample CSV</a>
...
function filterData(type = null){
	...
	$.ajax({
		...
		url: "<?php echo e(url('/admin/ingredients_paginate')); ?>",
...
function exportData(){
	...
	$.ajax({
		headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
		type: "POST",
		url: "<?php echo e(route('exports.Ingredients')); ?>",
		data: $('#searchForm').serialize(),
...
function UploadCSV(){
	if($.trim($('#upload_csv_file').val()) != ''){
		...
		$.ajax({
			headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
			url: "<?php echo e(route('imports.Ingredients')); ?>",
...
<?php echo $__env->make('layout.admin.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xampp-8\htdocs\aayush-bharat-admin\resources\views//admin/ingredients/index.blade.php ENDPATH**/ ?>