  ...
  <div class="page-title">
    <div class="row">
      <div class="col-12 col-md-6 order-md-1 order-last">
        <h3>Enquiries</h3>
        <p class="text-subtitle text-muted">Enquiries list.</p>
      </div>
  ...
  <section class="section">
    <div class="card"> 
      ...
      <div class="card-body"> 
        ...
        <form id="searchForm" name="searchForm" class="float-start">
          <div class="d-flex align-items-center  w-md-800px"> 
            ...
            <div class="position-relative w-md-200px me-md-2">
              <input id="name" name="name" type="text" confirmation="false" class="form-control" placeholder="Search By Name">
            </div>
            <div class="position-relative w-md-200px me-md-2">
              <select name="read_status" id="read_status" class="form-select" confirmation="false">
        ...
        <a onclick="exportData();" id="exportCsvBtn" class="btn icon btn-sm btn-outline-primary float-end" style="margin-left:10px">Export CSV</a> </div>
      <!--end::Card body--> 
    </div>
  </section>
...
function filterData(type = null){
	...
	$.ajax({
        ...
        type: 'POST',
		data: $('#searchForm').serialize(),
		url: "<?php echo e(url('/admin/enquiries_paginate')); ?>",
...
<?php echo $__env->make('layout.admin.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xampp-8.2\htdocs\laraval_ecommerce_admin\resources\views//admin/enquiries/index.blade.php ENDPATH**/ ?>