            ...
            <div class="card border-0">
              ...
              <div class = "product-imgs">
                <div class = "img-display">
                  <div class = "img-showcase">
                    <?php if($product->image == ''): ?>
                      <img src = "<?php echo e(asset('public/img/home/no-image.png')); ?>" alt = "shoe image">
                    <?php else: ?>
                    ...
                    <img src="<?php echo e(asset('public/admin/images/products/')); ?>/<?php echo e($image->image); ?>" alt="shoe image">
                ...
                <div class="img-select">
                  ...
                  <?php $__currentLoopData = $product_images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <div class="img-item">
                    <a href="#" data-id = "<?php echo e($key+2); ?>">
                      <img src="<?php echo e(asset('public/admin/images/products/')); ?>/<?php echo e($image->image); ?>" alt="shoe image">
                    </a>
                  </div>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      ...
      <div class="col text-start">
        <div class="pr-img">
          <div class="product-box-pt">
            ...
            <?php endif; ?>
            <div class="pro-cont">
              <a href="javascript:void(0)" id="add_to_cart_<?php echo e($product->id); ?>" onclick="addTocart('<?php echo e($product->id); ?>')" class="btn bg-orange">Add To Cart</a>
            </div>
          </div>
...
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vqtxcve1uvhl/sgj.365wah.com/resources/views/products/product_details.blade.php ENDPATH**/ ?>