        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Edit Footer Navigation</h3>
                </div>
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="<?php echo e(url('/admin')); ?>">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="<?php echo e(url('/admin/footer-navigations')); ?>">Footer Navigations</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Edit Footer Navigation</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <section class="section">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Edit Footer Navigation</h4>
                </div>
                <div class="card-body">
                        ...
                        <div class="col-md-7">
                            <div class="form-group">
                                ...
                                <select name="parent_id" id="parent_id" confirmation="false" class="form-control">
                                 <?php
                                    echo Helper::getNavigationCategory($footerNavigationList,$rowData->parent_id,$rowData->id);
                                 ?>
                                 </select>
                            </div>
                        </div>
...
<!-- end plugin js -->
<script>
    let saveDataURL = "<?php echo e(url('/admin/edit-footer-navigation/'.$row_id)); ?>";
    let returnURL = "<?php echo e(url('/admin/footer-navigations')); ?>";
...
<?php echo $__env->make('layout.admin.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xampp-8\htdocs\luxury-train\resources\views//admin/footer_navigations/edit-page.blade.php ENDPATH**/ ?>