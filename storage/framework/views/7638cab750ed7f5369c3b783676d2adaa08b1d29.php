    ...
    <div class="sidebar-wrapper active">
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                if($action =='admin.inner-pages' ||  $action =='admin.edit-inner-pages'){
                    $managerActive = $InnerPages = true;
                }
                ?>
                ...
                <li class="sidebar-item  has-sub <?php echo e($managerActive?'active':''); ?>">
                    ...
                    <ul class="submenu <?php echo e($managerActive ?'active':''); ?>">                        
                        <li class="submenu-item <?php echo e($InnerPages ?'active':''); ?>">
                            <a href="<?php echo e(url('/admin/inner-pages')); ?>">Inner Pages</a>
                        </li>
                        <li class="submenu-item <?php echo e($CmsPages ?'active':''); ?>">
                            <a href="<?php echo e(url('/admin/cms-pages')); ?>">CMS Pages</a>
                        </li>
                        <li class="submenu-item <?php echo e($HeaderNavigations ?'active':''); ?>">
                            <a href="<?php echo e(url('/admin/header-navigations')); ?>">Header Navigations</a>
                        </li>
                        <li class="submenu-item <?php echo e($FooterNavigations ?'active':''); ?>">
                            <a href="<?php echo e(url('/admin/footer-navigations')); ?>">Footer Navigations</a>
                        </li>
                    </ul>
                </li>
                <?php endif; ?>
                ...
                if($action =='admin.view-contact' || $action =='admin.contacts'){
                    $managerActive = $contacts = true;
                }
                ?>
                <li class="sidebar-item  has-sub <?php echo e($managerActive?'active':''); ?>">
                    <a href="#" class='sidebar-link'>
                    ...
                    <ul class="submenu <?php echo e($managerActive ?'active':''); ?>">
                        ...
                        <li class="submenu-item <?php echo e($contacts ?'active':''); ?>">
...
<?php /**PATH G:\xampp-8\htdocs\luxury-train\resources\views/element/admin/sidebar.blade.php ENDPATH**/ ?>