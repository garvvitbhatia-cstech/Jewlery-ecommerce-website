        ...
        <section class="section">
            <div class="card">
                ...
                <form class="form w-100" id="updateForm" action="#">
                    <div class="row">
                        <div class="col-md-6">
                            <input type="hidden" name="old_banner" value="<?php echo $userData->photo; ?>" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                    <div class="cropped" id="cropped">
                                        <div class="cropped" id="cropped"><img src="<?php echo e(URL::asset('public/admin/images/profile/')); ?>/<?php echo $userData->photo; ?>" width="150"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('layout.admin.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xampp-8.2\htdocs\laraval_ecommerce_admin\resources\views//admin/profile/update_profile.blade.php ENDPATH**/ ?>