   ...
   <section class="section">
      <div class="card">
         ...
         <div class="card-body">
            ...
            <a href="<?php echo e(url('/admin/add-product')); ?>" class="btn icon btn-sm btn-outline-success float-end">Add New Product</a>
         </div>
         <!--end::Card body-->
      </div>
   </section>
...
<?php echo $__env->make('layout.admin.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xampp-8.2\htdocs\laraval_ecommerce_admin\resources\views//admin/products/index.blade.php ENDPATH**/ ?>