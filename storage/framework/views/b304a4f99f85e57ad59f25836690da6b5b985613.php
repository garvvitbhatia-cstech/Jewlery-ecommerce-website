                  ...
                  <div class="row">
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <select name="parent_id" id="parent_id" confirmation="false" class="form-select">
                            <?php echo e(Helper::getSubCategory($categoryList)); ?>
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <textarea class="form-control" name="description" rows="6" placeholder="Description" id="description"></textarea>
                      </div>
                    </div>
                  </div>
                </div>                
...
<?php echo $__env->make('layout.admin.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xampp-8.2\htdocs\laraval_ecommerce_admin\resources\views//admin/categories/add-page.blade.php ENDPATH**/ ?>