  ...
  <div class="page-title">
    <div class="row">
      <div class="col-12 col-md-6 order-md-1 order-last">
        ...
        <p class="text-subtitle text-muted">Bidding History list.</p>
      </div>
        ...
        <form id="searchForm" name="searchForm" class="float-start">
          <div class="d-flex align-items-center  w-md-800px"> 
            ...
            <div class="position-relative w-md-200px me-md-2">
              <input id="product" name="product" type="text" confirmation="false" class="form-control" placeholder="Search By Product">
            </div>
            <div class="position-relative w-md-200px me-md-2">
              <input id="from_date" name="from_date" type="date" confirmation="false" class="form-control" placeholder="Search By from_date">
            </div>
            <div class="position-relative w-md-200px me-md-2">
              <input id="to_date" name="to_date" type="date" confirmation="false" class="form-control" placeholder="Search By to_date">
            </div>
...
function exportData(){
	...
	$.ajax({
		...
		type: "POST",
		url: "<?php echo e(route('exports.enquiries')); ?>",
...
function filterData(type = null){
	...
	$.ajax({
        ...
        type: 'POST',
		data: $('#searchForm').serialize(),
		url: "<?php echo e(url('/admin/user_biddings_paginate')); ?>",
...
<?php echo $__env->make('layout.admin.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vqtxcve1uvhl/sgj.365wah.com/resources/views//admin/user_biddings/index.blade.php ENDPATH**/ ?>