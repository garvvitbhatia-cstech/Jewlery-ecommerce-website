        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Inner Pages Management</h3>
                    <p class="text-subtitle text-muted">Inner pages list.</p>
                </div>
...
function filterData(type = null){
	...
	$.ajax({
		...
		url: "<?php echo e(url('/admin/inner_pages_paginate')); ?>",
...
<?php echo $__env->make('layout.admin.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xampp-8\htdocs\luxury-train\resources\views//admin/inner_pages/index.blade.php ENDPATH**/ ?>