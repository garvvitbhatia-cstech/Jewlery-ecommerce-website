                    ...
                    <div class="col-md-12 col-12"><h6 style="background-color: #f2f7ff;padding: 9px;" for="basicInput">Order Details</h6></div>
                      ...
                      <div class="col-md-12">
                            ...
                            <table class="table">
                              ...
                              <td><?php echo Helper::getProduct($order->product_id,'title'); ?></td> 
...
<?php echo $__env->make('layout.admin.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vqtxcve1uvhl/sgj.365wah.com/resources/views//admin/orders/view-page.blade.php ENDPATH**/ ?>