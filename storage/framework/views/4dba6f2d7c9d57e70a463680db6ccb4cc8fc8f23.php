...
<?php $__env->startSection('description','Order Success'); ?>
<?php $__env->startSection('keywords','Order Success'); ?>
        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="row mt-15 mb-4">
                ...
                <span>Order No: <?php echo e($order->invoice_id); ?></span>
...
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/a6xnk0irt52m/public_html/resources/views/checkout/order_thanks.blade.php ENDPATH**/ ?>