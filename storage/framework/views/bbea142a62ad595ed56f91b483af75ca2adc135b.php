                           ...
                           <div class="row">
                              ...
                              <div class="col-md-6">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input class="form-control" placeholder="Enter Title" name="title" id="title" value="<?php echo e($rowData->title); ?>">
                              ...
                              <div class="col-md-3">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="text" name="amount" id="amount" maxlength="8" placeholder="Price (INR)" value="<?php echo e($rowData->amount); ?>" class="form-control numberonly" />
                              ...
                              <div class="form-group">
                                 ...
                                 <input type="text" name="usd_price" id="usd_price" maxlength="8" placeholder="Price (USD)" value="<?php echo e($rowData->usd_price); ?>" class="form-control numberonly" />
                              ...
                              <div class="col-md-4">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control numberonly" placeholder="Enter Product Quantity" value="<?php echo e($rowData->quantity); ?>" name="quantity" id="quantity">
                              ...
                              <div class="col-md-12">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <textarea class="form-control editorBox" placeholder="Enter Short Description" name="content" id="content"><?php echo e($rowData->content); ?></textarea>
...
<?php echo $__env->make('layout.admin.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vqtxcve1uvhl/sgj.365wah.com/resources/views//admin/products/edit-page.blade.php ENDPATH**/ ?>