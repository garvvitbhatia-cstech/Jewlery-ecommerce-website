        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    ...
                    <p class="text-subtitle text-muted">Admin list.</p>
                </div>
            ...
            <div class="card">
               <!--begin::Card body-->
                <div class="card-body">
                    ...
                    <a href="<?php echo e(url('/admin/add-admin')); ?>" class="btn icon btn-sm btn-outline-success float-end">Add New Admin</a>
                </div>
                <!--end::Card body-->
            </div>
        </section>
...
function filterData(type = null){
	...
	$.ajax({
		...
		url: "<?php echo e(url('/admin/admins_paginate')); ?>",
...
<?php echo $__env->make('layout.admin.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vqtxcve1uvhl/mailwiz.365wah.com/resources/views//admin/admins/index.blade.php ENDPATH**/ ?>