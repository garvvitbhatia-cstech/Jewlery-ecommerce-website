<?php if($records->count()>0): ?>
    ...
    <tr>
        ...
        <td>
            <a href="<?php echo e(url('/admin/edit-admin',base64_encode($row->id))); ?>" class="btn btn-sm btn-primary" title="Edit">
...
<?php /**PATH G:\xampp-8.2\htdocs\vigore-travel\resources\views//admin/admins/paginate.blade.php ENDPATH**/ ?>