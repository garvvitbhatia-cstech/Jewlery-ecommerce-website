                           ...
                           <div class="row">
                              ...
                              <div class="col-md-4">
                                 <div class="form-group">
                                    ...
                                    <input type="text" name="amount" id="amount" maxlength="5" placeholder="Amount" value="<?php echo e($rowData->amount); ?>" class="form-control numberonly" />
                                 </div>
                              </div>
                              <div class="col-md-12">
                                 <div class="form-group">
...
<?php echo $__env->make('layout.admin.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xampp-8.2\htdocs\laraval_ecommerce_admin\resources\views//admin/products/edit-page.blade.php ENDPATH**/ ?>