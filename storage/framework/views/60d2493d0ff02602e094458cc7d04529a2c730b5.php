        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Cms Pages Management</h3>
                    <p class="text-subtitle text-muted">Cms pages list.</p>
                </div>
            ...
            <div class="card">
               <!--begin::Card body-->
                <div class="card-body">
                    ...
                    <a href="<?php echo e(url('/admin/add-cms-page')); ?>" class="btn icon btn-sm btn-outline-success float-end">Add Cms Page</a>
                </div>
                <!--end::Card body-->
            </div>
        </section>
...
function filterData(type = null){
	...
	$.ajax({
		...
		url: "<?php echo e(url('/admin/cms_pages_paginate')); ?>",
...
<?php echo $__env->make('layout.admin.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xampp-8\htdocs\luxury-train\resources\views//admin/cms_pages/index.blade.php ENDPATH**/ ?>