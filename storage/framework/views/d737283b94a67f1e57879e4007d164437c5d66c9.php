...
<div class="page-heading">
            ...
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Edit Symptom</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <?php
    $explodeAilment = explode(',',$rowData->ailment_id);
    $explodeSpeciality = explode(',',$rowData->speciality_id);
    $explodeSymptoms = explode(',',$rowData->symptom_id);
    ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <option <?php if(in_array($ailment->id,$explodeAilment)): ?> selected="selected" <?php endif; ?> value="<?php echo e($ailment->id); ?>"><?php echo e($ailment->title); ?></option>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <option <?php if(in_array($specialty->id,$explodeSpeciality)): ?> selected="selected" <?php endif; ?> value="<?php echo e($specialty->id); ?>"><?php echo e($specialty->title); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <option <?php if(in_array($symptom->id,$explodeSymptoms)): ?> selected="selected" <?php endif; ?> value="<?php echo e($symptom->id); ?>"><?php echo e($symptom->title); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                    </div>
                    <?php
                    $questions = explode(" | ",$rowData->questions);
                    ?>
                    <div class="col-md-6" id="question_div">
                        ...
                        <div id="row_<?php echo e($key); ?>" class="form-group">
                            <input type="text" class="form-control" value="<?php echo e($question); ?>" style="float:left;width:86%;" name="question[]">
                            <a style="float:right" onclick="removeRow('<?php echo e($key); ?>');" class="btn btn-sm btn-danger">Delete</a><div style="clear:both"></div>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
...
<!-- end plugin js -->
<script>
    let saveDataURL = "<?php echo e(url('/admin/edit-symptom/'.$row_id)); ?>";
...
<?php echo $__env->make('layout.admin.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xampp-8\htdocs\aayush-bharat-admin\resources\views//admin/symptoms/edit-page.blade.php ENDPATH**/ ?>