      ...
      <div class="col-12 col-md-6 order-md-2 order-first">
        <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="<?php echo e(url('/admin/brands')); ?>">Brand</a></li>
                  ...
                  <div class="row">        
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <textarea class="form-control editorBox" name="description" rows="6" placeholder="Description" id="description"></textarea>
                      </div>
                    </div>
                  </div>
                </div>                
...
<script>
    ...
    let saveDataURL = "<?php echo e(url('/admin/add-brand')); ?>";
    let returnURL = "<?php echo e(url('/admin/brands')); ?>";
</script> 
<script src="<?php echo e(asset('public/admin/js/pages/brands/add-page.js')); ?>"></script> 
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.admin.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vqtxcve1uvhl/sgj.365wah.com/resources/views//admin/brands/add-page.blade.php ENDPATH**/ ?>