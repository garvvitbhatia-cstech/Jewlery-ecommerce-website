                           ...
                           <div class="row">
                              ...
                              <div class="col-md-4">
                                 <div class="form-group">
                                    ...
                                    <input type="text" name="amount" id="amount" maxlength="5" placeholder="Amount" class="form-control numberonly" />
                                 </div>
                              </div>
                              <div class="col-md-12">
                                 <div class="form-group">
