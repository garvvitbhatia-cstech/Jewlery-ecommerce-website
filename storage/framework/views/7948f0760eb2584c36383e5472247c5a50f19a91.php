...
<!-- end plugin js --> 
<script>
    let saveDataURL = "<?php echo e(url('/admin/add-blog/')); ?>";
    let returnURL = "<?php echo e(url('/admin/blogs')); ?>";
</script>
<script src="<?php echo e(asset('public/admin/js/pages/blogs/add-page.js')); ?>"></script>
<?php $__env->stopSection(); ?> 
<?php echo $__env->make('layout.admin.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xampp-8\htdocs\aayush-bharat-admin\resources\views//admin/blogs/add-page.blade.php ENDPATH**/ ?>