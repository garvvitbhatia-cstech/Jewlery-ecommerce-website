...
<script>    
    ...
    let saveDataURL = "<?php echo e(url('/admin/add-account')); ?>";
    let returnURL = "<?php echo e(url('/admin/accounts')); ?>";
</script>
<script src="<?php echo e(asset('public/admin/js/pages/accounts/add-page.js')); ?>"></script>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.admin.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vqtxcve1uvhl/mailwiz.365wah.com/resources/views//admin/accounts/add-page.blade.php ENDPATH**/ ?>