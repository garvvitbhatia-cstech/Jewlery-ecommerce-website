                     ...
                     <div class="row">
                        ...
                        <div class="col-md-4">
                           <div class="form-group">
                              ...
                              <input type="text" class="form-control numberonly" maxlength="4" name="amount" id="amount">
                           </div>
                        </div>
                        <div class="col-md-4">
                           <div class="form-group">
...
<?php echo $__env->make('layout.admin.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vqtxcve1uvhl/sgj.365wah.com/resources/views//admin/coupon_codes/add-page.blade.php ENDPATH**/ ?>