    ...
    <tr>
    	<td>
         ...
         <td>
        	...
        	<!--<a target="_blank" href="<?php echo e(url('/admin/edit-product',base64_encode($row->id))); ?>" title="Edit">
        ...
        <!--<td>
            ...
            <?php else: ?>
            <a href="javascript:void(0);" class="badge bg-danger">In-Active</a>
            <?php endif; ?>
        </td>-->
        <td>
        	...
        	<?php
        	$vendor_status = Helper::getSellProductStatus($row->id,$admin_id); 
            ?>
            <?php if($vendor_status == NULL): ?>
         		<!--<a href="javascript:void(0);" onclick="sellProduct('<?php echo e($row->id); ?>');" id="sell_this_btn_<?php echo e($row->id); ?>" class="btn btn-sm btn-primary"  title="Sell Product">-->
           	<a href="<?php echo e(url('/admin/vendor-edit-product',base64_encode($row->id))); ?>/add" title="Sell This" class="btn btn-sm btn-primary">
                Sell This
            </a>
                    
                </a>
            <?php else: ?>
            	<span style="color:#F00"><?php echo e($vendor_status); ?></span>
            <?php endif; ?>
...
<?php /**PATH G:\xampp-8\htdocs\aayush-bharat-admin\resources\views//admin/vendor_sales/paginate.blade.php ENDPATH**/ ?>