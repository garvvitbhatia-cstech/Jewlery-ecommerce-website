                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Plan Cost" value="<?php echo e($rowData->cost); ?>" name="cost" id="cost">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                        <div class="form-group">
...
<script>
    let saveDataURL = "<?php echo e(url('/admin/edit-subscription/'.$row_id)); ?>";
...
<?php echo $__env->make('layout.admin.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xampp-8\htdocs\luxury-train\resources\views//admin/subscriptions/edit-page.blade.php ENDPATH**/ ?>