                        ...
                        <?php if($rowData->image != ""): ?>
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <img src="<?php echo e(URL::asset('public/img/categories/')); ?>/<?php echo $rowData->image; ?>" width="100">
                                </div>
                            </div>
                        <?php endif; ?>
...
<?php echo $__env->make('layout.admin.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xampp-8\htdocs\luxury-train\resources\views//admin/categories/edit-page.blade.php ENDPATH**/ ?>