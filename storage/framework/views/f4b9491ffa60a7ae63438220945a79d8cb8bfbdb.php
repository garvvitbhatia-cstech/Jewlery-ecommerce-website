        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item  has-sub <?php echo e($managerActive?'active':''); ?>">
                    ...
                    <ul class="submenu <?php echo e($managerActive ?'active':''); ?>">
                        <li class="submenu-item <?php echo e($ailmentsActive ?'active':''); ?>">
                            <a href="<?php echo e(url('/admin/ailments')); ?>">Ailments</a>
                        </li>
                        <li class="submenu-item <?php echo e($consultationTypes ?'active':''); ?>">
                            <a href="<?php echo e(url('/admin/consultation-types')); ?>">Consultation Types</a>
                        </li>

                        <li class="submenu-item <?php echo e($labTest ?'active':''); ?>">
                            <a href="<?php echo e(url('/admin/lab-tests')); ?>">Lab Tests</a>
                        </li>
                        <li class="submenu-item <?php echo e($labTestInstructions ?'active':''); ?>">
                            <a href="<?php echo e(url('/admin/lab-test-instructions')); ?>">Lab Test Instructions</a>
                        </li>
                        ...
                        <li class="submenu-item <?php echo e($licenseJurisdictionActive ?'active':''); ?>">
                            <a href="<?php echo e(url('/admin/license-jurisdictions')); ?>">License Jurisdictions</a>
                        </li>
                        <li class="submenu-item <?php echo e($pathy ?'active':''); ?>">
                            <a href="<?php echo e(url('/admin/pathy')); ?>">Pathy</a>
                        </li>
                        <li class="submenu-item <?php echo e($practices ?'active':''); ?>">
                            <a href="<?php echo e(url('/admin/practices')); ?>">Practices</a>
                        </li>
                        <li class="submenu-item <?php echo e($qualificationTypes ?'active':''); ?>">
                            <a href="<?php echo e(url('/admin/qualification-types')); ?>">Qualification Types</a>
                        </li>
                        ...
                        <li class="submenu-item <?php echo e($specialties ?'active':''); ?>">
                            <a href="<?php echo e(url('/admin/specialties')); ?>">Specialties</a>
                        </li>
                        <li class="submenu-item <?php echo e($banks ?'active':''); ?>">
                            <a href="<?php echo e(url('/admin/banks')); ?>">Banks</a>
                        </li>
                        <li class="submenu-item <?php echo e($languages ?'active':''); ?>">
                            <a href="<?php echo e(url('/admin/languages')); ?>">Languages</a>
                        </li>
                        <li class="submenu-item <?php echo e($languageProficiencies ?'active':''); ?>">
                            <a href="<?php echo e(url('/admin/language-proficiencies')); ?>">Language Proficiencies</a>
                        </li>
                        <li class="submenu-item <?php echo e($symptoms ?'active':''); ?>">
                            <a href="<?php echo e(url('/admin/symptoms')); ?>">Symptoms</a>
                        </li>
                        <li class="submenu-item <?php echo e($status ?'active':''); ?>">
                            <a href="<?php echo e(url('/admin/status')); ?>">Status</a>
                        </li>
                        <li class="submenu-item <?php echo e($taxes ?'active':''); ?>">
                            <a href="<?php echo e(url('/admin/taxes')); ?>">Taxes</a>
                        </li>
                ...
                <li class="sidebar-item  has-sub <?php echo e($managerActive?'active':''); ?>">
                    ...
                    <ul class="submenu <?php echo e($managerActive ?'active':''); ?>">
                        ...
                        <li class="submenu-item <?php echo e($ingredientsActive ?'active':''); ?>">
                            <a href="<?php echo e(url('/admin/ingredients')); ?>">Ingredients</a>
                        </li>
                        <li class="submenu-item <?php echo e($unitsActive ?'active':''); ?>">
                            <a href="<?php echo e(url('/admin/units')); ?>">Units</a>
                        </li>
                        <?php endif; ?>                        
                        <li class="submenu-item <?php echo e($disapprovedProductsActive ?'active':''); ?>">
                            <a href="<?php echo e(url('/admin/disapproved-products')); ?>">Disapproved Products</a>
                        </li> 
                        <?php if(Session::get('admin_type') == 'Admin'): ?>
                        <li class="submenu-item <?php echo e($productsActive ?'active':''); ?>">
                            <a href="<?php echo e(url('/admin/products')); ?>">Products</a>
                        </li>
                        <li class="submenu-item <?php echo e($moderationProductsActive ?'active':''); ?>">
                            <a href="<?php echo e(url('/admin/moderation-products')); ?>">Moderation Products</a>
                        </li>
                        <?php else: ?>
                        <li class="submenu-item <?php echo e($productsActive ?'active':''); ?>">
...
<?php /**PATH G:\xampp-8\htdocs\aayush-bharat-admin\resources\views/element/admin/sidebar.blade.php ENDPATH**/ ?>