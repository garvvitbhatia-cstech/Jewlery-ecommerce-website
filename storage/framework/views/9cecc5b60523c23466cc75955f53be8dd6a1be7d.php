                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Enter Sub Category Title" value="" name="title" id="title">
                            </div>
                        </div>
...
<!-- end plugin js -->
<script>
    let saveDataURL = "<?php echo e(url('/admin/add-sub-category')); ?>";
...
<?php echo $__env->make('layout.admin.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xampp-8\htdocs\aayush-bharat-admin\resources\views//admin/sub_categories/add-page.blade.php ENDPATH**/ ?>