<?php if($records->count()>0): ?>
    ...
    <tr>
        ...
        <td>
            ...
            <?php endif; ?>
            <?php endif; ?>        	
            <a href="<?php echo e(url('/admin/view-moderation-product',base64_encode($row->id))); ?>" class="btn btn-sm btn-primary" title="View Product Info">
                <i class="bi bi-eye"></i>
            </a>
            <?php if($admin_type == 'Admin'): ?>
            <a href="<?php echo e(url('/admin/edit-product',base64_encode($row->id))); ?>" class="btn btn-sm btn-primary" title="Edit">
...
<?php /**PATH G:\xampp-8\htdocs\aayush-bharat-admin\resources\views//admin/moderation_products/paginate.blade.php ENDPATH**/ ?>