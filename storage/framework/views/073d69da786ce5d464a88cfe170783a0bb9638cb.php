...
function changeCategoryStatus(table,rowID,status,field){
	$.ajax({
        type: 'POST',
        url: "<?php echo e(url('/admin/change-category-status')); ?>",
        headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
        data: {table:table,rowID:rowID,status:status,field:field},
...
<?php echo $__env->make('layout.admin.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xampp-8.2\htdocs\laraval_ecommerce_admin\resources\views//admin/categories/index.blade.php ENDPATH**/ ?>