        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Disapproved Products Management</h3>
                ...
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Disapproved Products</li>
                        </ol>
                    </nav>
                </div>
            </div>
...
<div class="modal fade text-left" id="declinedReasonPopup" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" id="declinedReasonBox">
...
function filterData(type = null){
	...
	$.ajax({
		...
		url: "<?php echo e(url('/admin/disapproved_products_paginate')); ?>",
...
<?php echo $__env->make('layout.admin.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xampp-8\htdocs\aayush-bharat-admin\resources\views//admin/disapproved_products/index.blade.php ENDPATH**/ ?>