          ...
          <div class="row align-items-center">
            <div class="col-md-6">
              <div class="hero-banner-text">
                ...
                <div class="btn-set">
                  <?php if($banner->btn1_title != '' && $banner->btn1_url != '' && $banner->is_show_btn1 == 1): ?>
                    <a href="<?php echo e($banner->btn1_url); ?>" class="btn"><?php echo e($banner->btn1_title); ?></a>
                  <?php endif; ?>

                  <?php if($banner->btn2_title != '' && $banner->btn2_url != '' && $banner->is_show_btn2 == 1): ?>
                    <a href="<?php echo e($banner->btn2_url); ?>" class="btn outline"><?php echo e($banner->btn2_title); ?></a>
                  <?php endif; ?>
                </div>
              </div>
            </div>
        ...
        <!--<?php if(isset($inner_page->id)): ?>
          ...
          <div class="col-md-12 px-0">
            <div class="offer-box second">
              <video muted autoplay playsinline loop>
                <source src="<?php echo e(asset('public/img/home-videos/6262756-uhd_3840_2160_25fps.mp4')); ?>" width="100%" type="video/mp4">
              </video>
              <div class="right-offer">
...
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/a6xnk0irt52m/public_html/resources/views/pages/index.blade.php ENDPATH**/ ?>