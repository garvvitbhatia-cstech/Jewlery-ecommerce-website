        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Vendor Plan Category Management</h3>
                    <p class="text-subtitle text-muted">Vendor Plan Category list.</p>
                </div>
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="<?php echo e(url('/admin')); ?>">Dashboard</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Vendor Plan Categories</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="card">
               <!--begin::Card body-->
                <div class="card-body">
                    ...
                    <a href="<?php echo e(url('/admin/add-vendor-plan-category')); ?>" class="btn icon btn-sm btn-outline-success float-end">Add New Vendor Plan Category</a>
    ...
    <div class="modal fade" id="uploadCsvModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <a href="<?php echo e(url('/storage/sample-csv/vendor-plan-category.csv')); ?>" target="_blank" class="btn btn-success">Download Sample CSV</a>
...
function filterData(type = null){
	...
	$.ajax({
		...
		url: "<?php echo e(url('/admin/vendor_plan_category_paginate')); ?>",
...
function exportData(){
	...
	$.ajax({
		headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
		type: "POST",
		url: "<?php echo e(route('exports.vendor.plan.category')); ?>",
		data: $('#searchForm').serialize(),
...
function UploadCSV(){
	if($.trim($('#upload_csv_file').val()) != ''){
		...
		$.ajax({
			headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
			url: "<?php echo e(route('imports.vendor.plan.category')); ?>",
...
<?php echo $__env->make('layout.admin.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xampp-8\htdocs\laraval-new-admin\resources\views//admin/vendor_plan_category/index.blade.php ENDPATH**/ ?>