   ...
   <div class="page-title">
      <div class="row">
         <div class="col-12 col-md-6 order-md-1 order-last">
            ...
            <p class="text-subtitle text-muted">FAQ's list.</p>
         </div>
   ...
   <section class="section">
      <div class="card">
         ...
         <div class="card-body">
            ...
            <form id="searchForm" name="searchForm" class="float-start">
               <div class="d-flex align-items-center w-md-800px">
                  ...
                  <div class="position-relative w-md-200px me-md-2">
                     <input id="question" name="question" confirmation="false" class="form-control" placeholder="Question">
                  </div>
                  <div class="position-relative w-md-200px me-md-2">
                     <input id="answer" name="answer" confirmation="false" class="form-control" placeholder="Answer">
                  </div>
                  <div class="position-relative w-md-200px me-md-2">
                     <select id="status" name="status" confirmation="false" class="form-select" placeholder="status">
            ...
            <a href="<?php echo e(url('/admin/add-faq')); ?>" class="btn icon btn-sm btn-outline-success float-end">Add New Faq</a>
         </div>
         <!--end::Card body-->
      </div>
   </section>
   ...
   function filterData(type = null){   
       if(type =='search'){$('#searchbuttons').html('Searching..');}   
   		$.ajax({   
			...
			url: "<?php echo e(url('/admin/faqs_paginate')); ?>",	   
...
<?php echo $__env->make('layout.admin.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vqtxcve1uvhl/sgj.365wah.com/resources/views//admin/faqs/index.blade.php ENDPATH**/ ?>