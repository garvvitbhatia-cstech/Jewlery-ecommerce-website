...
function changeBidderStatus(table,rowID,status){
	$.ajax({
        type: 'POST',
        url: "<?php echo e(url('/admin/change-bidder-status')); ?>",
...
<?php echo $__env->make('layout.admin.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vqtxcve1uvhl/sgj.365wah.com/resources/views//admin/users/index.blade.php ENDPATH**/ ?>