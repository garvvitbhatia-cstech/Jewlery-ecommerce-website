                           ...
                           <div class="row">
                              ...
                              <div class="col-md-4">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="text" name="amount" id="amount" maxlength="8" placeholder="Actual Amount" value="<?php echo e($rowData->amount); ?>" class="form-control numberonly" />
                              ...
                              <div class="col-md-4">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="text" name="start_price" id="start_price" maxlength="8" value="<?php echo e($rowData->start_price); ?>" placeholder="Start Price" class="form-control numberonly" />
                              ...
                              <div class="col-md-4">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="datetime-local" name="start_date" id="start_date" placeholder="Start Price" value="<?php echo e($rowData->start_date); ?>"  class="form-control"/>
                              ...
                              <div class="col-md-4">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="datetime-local" name="end_date" id="end_date"  placeholder="Start Price" value="<?php echo e($rowData->end_date); ?>"  class="form-control"/>
                              ...
                              <div class="col-md-4">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="text" name="quantity" id="quantity"  placeholder="Quantity" value="<?php echo e($rowData->quantity); ?>" class="form-control numberonly"/>
                              ...
                              <div class="col-md-4">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter Gross Weight" value="<?php echo e($rowData->gross_weight); ?>" name="gross_weight" id="gross_weight">
                              ...
                              <div class="col-md-4">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter Rubellite Weight" value="<?php echo e($rowData->rubellite_weight); ?>" name="rubellite_weight" id="rubellite_weight">
                              ...
                              <div class="col-md-4">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter Tanzanite Weight" value="<?php echo e($rowData->tanzanite_weight); ?>" name="tanzanite_weight" id="tanzanite_weight">
                              ...
                              <div class="col-md-12">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <textarea class="form-control editorBox" placeholder="Enter Content" value="" name="content" id="content"><?php echo e($rowData->content); ?></textarea>
                              ...
                              <div class="col-md-12">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <textarea class="form-control editorBox" placeholder="Enter Description" value="" name="description" id="description"><?php echo e($rowData->description); ?></textarea>
...
<?php echo $__env->make('layout.admin.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vqtxcve1uvhl/sgj.365wah.com/resources/views//admin/bidding_products/edit-page.blade.php ENDPATH**/ ?>