            ...
            <div class="card">
               <!--begin::Card body-->
                <div class="card-body">
                    ...
                    <form id="searchForm" name="searchForm" class="float-start">
                        <div class="d-flex align-items-center  w-md-800px">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <button type="reset" class="btn btn-sm btn-dark btn-active-light-primary me-5" data-kt-menu-dismiss="true"  onclick="filterData();">Reset</button>
                            </div>
                            <!--end:Action-->
                        </div>
                    </form>
                    ...
                    <a href="<?php echo e(url('/admin/add-user')); ?>" class="btn icon btn-sm btn-outline-success float-end">Add New Customer</a>
                </div>
                <!--end::Card body-->
            </div>
        </section>
    ...
    <div class="modal fade" id="uploadCsvModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <a href="<?php echo e(url('/storage/sample-csv/customers.csv')); ?>" target="_blank" class="btn btn-success">Download Sample CSV</a>
...
function filterData(type = null){
	...
	$.ajax({
		...
		url: "<?php echo e(url('/admin/users_paginate')); ?>",
...
function UploadCSV(){
	if($.trim($('#upload_csv_file').val()) != ''){
		...
		$.ajax({
			headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
			url: "<?php echo e(route('imports.customer')); ?>",
...
<?php echo $__env->make('layout.admin.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vqtxcve1uvhl/mailwiz.365wah.com/resources/views//admin/users/index.blade.php ENDPATH**/ ?>