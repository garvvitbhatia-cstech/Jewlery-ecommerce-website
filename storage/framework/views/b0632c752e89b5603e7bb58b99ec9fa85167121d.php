                    ...
                    <div class="col-lg-8 mb-4">
                        ...
                        <div class="cart-list-main wow fadeInUp">
                            ...
                            <div class="cart-item-details">
                                <div class="cart-product-name fw-bold"><a href="#"><?php echo e(Helper::getProduct($item->product_id,'title')); ?></a></div>
                                <div class="d-flex align-items-center">
                                    <div class="price ms-3"><big>₹<?php echo e($item->price); ?> per item</big></div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="cart-total-box">
                            <div class="total-price">
                                <p>Total:</p>
                                <p class="fw-bold">₹<?php echo e(number_format($totalPrice,2)); ?></p>
                            </div>
                        </div>
...
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vqtxcve1uvhl/sgj.365wah.com/resources/views/pages/cart.blade.php ENDPATH**/ ?>