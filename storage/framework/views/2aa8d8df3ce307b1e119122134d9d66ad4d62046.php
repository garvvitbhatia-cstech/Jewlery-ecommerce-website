<?php if($records->count()>0): ?>
    ...
    <tr>
        ...
        <td>
            <a href="<?php echo e(url('/admin/edit-account',base64_encode($row->id))); ?>" class="btn btn-sm btn-primary" title="Edit">
    ...
    <tr>
        <td align="center" colspan="9">
            <div id="pagination"><?php echo e($records->links('vendor.pagination.custom')); ?></div>
        </td>
    </tr>


<?php /**PATH G:\xampp-8.2\htdocs\vigore-travel\resources\views//admin/accounts/paginate.blade.php ENDPATH**/ ?>