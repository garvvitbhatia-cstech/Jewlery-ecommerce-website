                           ...
                           <div class="row">
                              ...
                              <div class="col-md-4">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="text" name="amount" id="amount" maxlength="8" placeholder="Actual Price" class="form-control numberonly" />
                              ...
                              <div class="col-md-4">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="text" name="start_price" id="start_price" maxlength="8" placeholder="Start Price" class="form-control numberonly" />
                              ...
                              <div class="col-md-4">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="datetime-local" name="start_date" id="start_date" placeholder="Start Price" class="form-control"/>
                              ...
                              <div class="col-md-4">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="datetime-local" name="end_date" id="end_date"  placeholder="Start Price" class="form-control"/>
                              ...
                              <div class="col-md-4">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="text" name="quantity" id="quantity"  placeholder="Quantity" class="form-control numberonly"/>
                              ...
                              <div class="col-md-4">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter Gross Weight" value="" name="gross_weight " id="gross_weight">
                              ...
                              <div class="col-md-4">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter Rubellite Weight" value="" name="rubellite_weight" id="rubellite_weight">
                              ...
                              <div class="col-md-4">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter Tanzanite Weight" value="" name="tanzanite_weight" id="tanzanite_weight">
                              ...
                              <div class="col-md-12">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter Title" rows="3" value="" name="title" id="title"/>
...
<?php echo $__env->make('layout.admin.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vqtxcve1uvhl/sgj.365wah.com/resources/views//admin/bidding_products/add-page.blade.php ENDPATH**/ ?>