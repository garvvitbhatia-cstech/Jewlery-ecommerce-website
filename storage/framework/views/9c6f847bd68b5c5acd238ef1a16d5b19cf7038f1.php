                ...
                <form action="" method="post" id="checkout-form" class="shipping-adderss-main my-4">
                    ...
                    <div class="row g-3 my-2">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" value="<?php echo e(isset($explodeName[0]) ? $explodeName[0] : ''); ?>" id="o_first_name" name="o_first_name" placeholder="Enter your first name">
                        </div>
                        <div class="col-md-6">
                            <label for="o_last_name" class="form-label">Last Name</label>
                            <input type="text" class="form-control" id="o_last_name" name="o_last_name" value="<?php echo e(isset($explodeName[1]) ? $explodeName[1] : ''); ?>" placeholder="Enter your last name" >
                        </div>
                        
                        <div class="col-md-12">
                            <label for="o_address" class="form-label">Address</label>
                            <input type="text" class="form-control" id="o_address" value="<?php echo e($userData->address); ?>" name="o_address" placeholder="Enter your address" >
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="o_country" id="o_country" class="form-select">
                                ...
                                <?php $__currentLoopData = $country_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option <?php if($userData->country == $country->id): ?> selected <?php endif; ?> value="<?php echo e($country->country_name); ?>"><?php echo e($country->country_name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        <div class="col-md-4">
                            <label for="o_pincode" class="form-label">Pincode</label>
                            <input type="text" class="form-control numberonly" id="o_pincode" name="o_pincode" value="<?php echo e($userData->zipcode); ?>" maxlength="6" placeholder="6 digits pincode" >
                        </div>
                        <div class="col-md-4">
                            <label for="o_mobile" class="form-label">Phone No</label>
                            <input type="text" class="form-control numberonly" maxlength="10" name="o_mobile" value="<?php echo e($userData->mobile); ?>" id="o_mobile" placeholder="Enter your phone no">
                        </div>
                    ...
                    <div class="accordion myOrder-tab-cls" id="accordionExample">
                            ...
                            <div id="collapsethree" class="accordion-collapse show collapse" aria-labelledby="headingtwo" data-bs-parent="#accordionExample">
                                ...
                                <div class="product-list my-3 d-flex">
                                    ...
                                    <div class="kk-contant-boxb cart-box-cnt w-100 d-flex justify-content-between">
                                        <span>
                                            <a href="#" class="d-block cat-head fs-1 text-capitalize"><?php echo e($product_details->title); ?></a>
                                            <span class="d-flex kk-price-num align-items-center py-1"> per item</span>
                                        </span>
                                        <div class="price"><small class="fs-6">₹<?php echo e($product_details->amount); ?></small></div>
                                    </div>
                                </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>                             
                        ...
                        <div class="cart-total-box">
                            ...
                            <div class="total-price">
                                ...
                                <?php else: ?>
                                    <p class="fw-bold grand-total-inner-left-md">₹<?php echo e($sum); ?></p>
                                <?php endif; ?> 
                            </div>
                        </div>
...
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/a6xnk0irt52m/public_html/resources/views//checkout/checkout.blade.php ENDPATH**/ ?>