                           ...
                           <div class="row">
                              ...
                              <div class="col-md-4">
                                 <div class="form-group">
                                    ...
                                    <input type="text" name="amount" id="amount" maxlength="5" placeholder="Actual Amount" value="<?php echo e($rowData->amount); ?>" class="form-control numberonly" />
                                 </div>
                              </div>
                              <div class="col-md-4">
                                 <div class="form-group">
                                    <label for="basicInput">Start Price</label>
                                    <input type="text" name="start_price" id="start_price" maxlength="5" value="<?php echo e($rowData->start_price); ?>" placeholder="Start Price" class="form-control numberonly" />
                                 </div>
                              </div>
                              <div class="col-md-12">
                                 <div class="form-group">
                                    <label for="basicInput">Title</label>
                                    <textarea class="form-control" placeholder="Enter Description" rows="3" value="" name="title" id="title"><?php echo e($rowData->title); ?></textarea>
                                 </div>
                              </div>
                              <div class="col-md-12">
                                 <div class="form-group">
...
<?php echo $__env->make('layout.admin.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xampp-8.2\htdocs\laraval_ecommerce_admin\resources\views//admin/bidding_products/edit-page.blade.php ENDPATH**/ ?>