    ...
    <div class="header">
      <!--Main header start-->
        <nav class="navbar navbar-expand-lg">
              ...
              <img src="<?php echo e(asset('public/img/home/')); ?>/sgj_logo.png" class="img-fluid" alt=""></a>
                              ...
                              <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <?php if(isset($all_categories) && $all_categories->count()>0): ?>
                                      ...
                                      <li><a href="<?php echo e(url('products/')); ?>/<?php echo e($category->slug); ?>" class="dropdown-item" href="product_list"><?php echo e($category->title); ?></a></li>
...
<?php /**PATH /home/vqtxcve1uvhl/sgj.365wah.com/resources/views/element/header.blade.php ENDPATH**/ ?>